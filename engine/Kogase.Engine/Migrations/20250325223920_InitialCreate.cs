...
namespace Kogase.Engine.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Events_ProjectId_EventType_Timestamp",
                table: "Events",
                columns: new[] { "ProjectId", "EventType", "Timestamp" });

            migrationBuilder.CreateIndex(
                name: "IX_Metrics_ProjectId_MetricType_Period_PeriodStart",
                table: "Metrics",
                columns: new[] { "ProjectId", "MetricType", "Period", "PeriodStart" });
